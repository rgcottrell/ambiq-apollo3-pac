...
#[doc = r" Proxy"]
pub struct _DFIFOFULLW<'a> {
    w: &'a mut W,
}
impl<'a> _DFIFOFULLW<'a> {
...
impl W {
    ...
    #[doc = "Bit 1 - Trigger DMA upon FIFO 100 percent Full"]
    #[inline]
    pub fn dfifofull(&mut self) -> _DFIFOFULLW {
        _DFIFOFULLW { w: self }
    }
    #[doc = "Bit 0 - Trigger DMA upon FIFO 75 percent Full"]
    #[inline]
    pub fn dfifo75(&mut self) -> _DFIFO75W {
        _DFIFO75W { w: self }
    }
}
