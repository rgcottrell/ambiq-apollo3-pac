...
impl W {
    ...
    #[doc = "Bits 24:29 - Hours Alarm"]
    #[inline]
    pub fn almhr(&mut self) -> _ALMHRW {
        _ALMHRW { w: self }
    }
    #[doc = "Bits 16:22 - Minutes Alarm"]
    #[inline]
    pub fn almmin(&mut self) -> _ALMMINW {
        _ALMMINW { w: self }
    }
    #[doc = "Bits 8:14 - Seconds Alarm"]
    #[inline]
    pub fn almsec(&mut self) -> _ALMSECW {
        _ALMSECW { w: self }
    }
    #[doc = "Bits 0:7 - 100ths of a second Alarm"]
    #[inline]
    pub fn alm100(&mut self) -> _ALM100W {
        _ALM100W { w: self }
    }
}
