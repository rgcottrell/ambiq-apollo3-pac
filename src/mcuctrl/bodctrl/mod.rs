...
#[doc = r" Proxy"]
pub struct _BODHVREFSELW<'a> {
    w: &'a mut W,
}
impl<'a> _BODHVREFSELW<'a> {
...
#[doc = r" Proxy"]
pub struct _BODLVREFSELW<'a> {
    w: &'a mut W,
}
impl<'a> _BODLVREFSELW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - BODH External Reference Select. Note: the SWE mux select in PWRSEQ2SWE must be set for this to take effect."]
    #[inline]
    pub fn bodhvrefsel(&mut self) -> _BODHVREFSELW {
        _BODHVREFSELW { w: self }
    }
    #[doc = "Bit 4 - BODL External Reference Select. Note: the SWE mux select in PWRSEQ2SWE must be set for this to take effect."]
    #[inline]
    pub fn bodlvrefsel(&mut self) -> _BODLVREFSELW {
        _BODLVREFSELW { w: self }
    }
    #[doc = "Bit 3 - BODF Power Down."]
    #[inline]
    pub fn bodfpwd(&mut self) -> _BODFPWDW {
        _BODFPWDW { w: self }
    }
    #[doc = "Bit 2 - BODC Power Down."]
    #[inline]
    pub fn bodcpwd(&mut self) -> _BODCPWDW {
        _BODCPWDW { w: self }
    }
    #[doc = "Bit 1 - BODH Power Down."]
    #[inline]
    pub fn bodhpwd(&mut self) -> _BODHPWDW {
        _BODHPWDW { w: self }
    }
    #[doc = "Bit 0 - BODL Power Down."]
    #[inline]
    pub fn bodlpwd(&mut self) -> _BODLPWDW {
        _BODLPWDW { w: self }
    }
}
