...
impl super::DMASRAMREADPROTECT1 {
...
#[doc = r" Proxy"]
pub struct _DMA_RPROT1W<'a> {
    w: &'a mut W,
}
impl<'a> _DMA_RPROT1W<'a> {
...
impl R {
    ...
    #[inline]
    pub fn dma_rprot1(&self) -> DMA_RPROT1R {
        let bits = {
            const MASK: u16 = 65535;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:15 - Read protect SRAM from DMA. Each bit provides write protection for an 8KB region of memory. When set to 1, the region will be protected from DMA reads, when set to 0, DMA may read the region."]
    #[inline]
    pub fn dma_rprot1(&mut self) -> _DMA_RPROT1W {
        _DMA_RPROT1W { w: self }
    }
}
