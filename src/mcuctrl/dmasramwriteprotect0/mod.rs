...
impl super::DMASRAMWRITEPROTECT0 {
...
#[doc = r" Proxy"]
pub struct _DMA_WPROT0W<'a> {
    w: &'a mut W,
}
impl<'a> _DMA_WPROT0W<'a> {
...
impl R {
    ...
    #[inline]
    pub fn dma_wprot0(&self) -> DMA_WPROT0R {
        let bits = {
            const MASK: u32 = 4294967295;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:31 - Write protect SRAM from DMA. Each bit provides write protection for an 8KB region of memory. When set to 1, the region will be protected from DMA writes, when set to 0, DMA may write the region."]
    #[inline]
    pub fn dma_wprot0(&mut self) -> _DMA_WPROT0W {
        _DMA_WPROT0W { w: self }
    }
}
