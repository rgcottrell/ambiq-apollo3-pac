...
pub struct DCODEFAULTADDRR {
    bits: u32,
}
impl DCODEFAULTADDRR {
...
#[doc = r" Proxy"]
pub struct _DCODEFAULTADDRW<'a> {
    w: &'a mut W,
}
impl<'a> _DCODEFAULTADDRW<'a> {
...
impl W {
    ...
    #[doc = "Bits 0:31 - The DCODE bus address observed when a Bus Fault occurred. Once an address is captured in this field, it is held until the corresponding Fault Observed bit is cleared in the FAULTSTATUS register."]
    #[inline]
    pub fn dcodefaultaddr(&mut self) -> _DCODEFAULTADDRW {
        _DCODEFAULTADDRW { w: self }
    }
}
