...
pub struct ICODEFAULTADDRR {
    bits: u32,
}
impl ICODEFAULTADDRR {
...
#[doc = r" Proxy"]
pub struct _ICODEFAULTADDRW<'a> {
    w: &'a mut W,
}
impl<'a> _ICODEFAULTADDRW<'a> {
...
impl W {
    ...
    #[doc = "Bits 0:31 - The ICODE bus address observed when a Bus Fault occurred. Once an address is captured in this field, it is held until the corresponding Fault Observed bit is cleared in the FAULTSTATUS register."]
    #[inline]
    pub fn icodefaultaddr(&mut self) -> _ICODEFAULTADDRW {
        _ICODEFAULTADDRW { w: self }
    }
}
