...
impl super::DMASRAMWRITEPROTECT1 {
...
#[doc = r" Proxy"]
pub struct _DMA_WPROT1W<'a> {
    w: &'a mut W,
}
impl<'a> _DMA_WPROT1W<'a> {
...
impl R {
    ...
    #[inline]
    pub fn dma_wprot1(&self) -> DMA_WPROT1R {
        let bits = {
            const MASK: u16 = 65535;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:15 - Write protect SRAM from DMA. Each bit provides write protection for an 8KB region of memory. When set to 1, the region will be protected from DMA writes, when set to 0, DMA may write the region."]
    #[inline]
    pub fn dma_wprot1(&mut self) -> _DMA_WPROT1W {
        _DMA_WPROT1W { w: self }
    }
}
