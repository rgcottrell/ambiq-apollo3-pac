...
impl super::DMASRAMREADPROTECT0 {
...
#[doc = r" Proxy"]
pub struct _DMA_RPROT0W<'a> {
    w: &'a mut W,
}
impl<'a> _DMA_RPROT0W<'a> {
...
impl R {
    ...
    #[inline]
    pub fn dma_rprot0(&self) -> DMA_RPROT0R {
        let bits = {
            const MASK: u32 = 4294967295;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bits 0:31 - Read protect SRAM from DMA. Each bit provides write protection for an 8KB region of memory. When set to 1, the region will be protected from DMA reads, when set to 0, DMA may read the region."]
    #[inline]
    pub fn dma_rprot0(&mut self) -> _DMA_RPROT0W {
        _DMA_RPROT0W { w: self }
    }
}
