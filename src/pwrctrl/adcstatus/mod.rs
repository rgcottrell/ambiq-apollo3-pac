...
#[doc = r" Proxy"]
pub struct _REFBUFPWDW<'a> {
    w: &'a mut W,
}
impl<'a> _REFBUFPWDW<'a> {
...
#[doc = r" Proxy"]
pub struct _REFKEEPPWDW<'a> {
    w: &'a mut W,
}
impl<'a> _REFKEEPPWDW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 5 - This bit indicates that the ADC REFBUF is powered down"]
    #[inline]
    pub fn refbufpwd(&mut self) -> _REFBUFPWDW {
        _REFBUFPWDW { w: self }
    }
    #[doc = "Bit 4 - This bit indicates that the ADC REFKEEP is powered down"]
    #[inline]
    pub fn refkeeppwd(&mut self) -> _REFKEEPPWDW {
        _REFKEEPPWDW { w: self }
    }
    #[doc = "Bit 3 - This bit indicates that the ADC VBAT resistor divider is powered down"]
    #[inline]
    pub fn vbatpwd(&mut self) -> _VBATPWDW {
        _VBATPWDW { w: self }
    }
    #[doc = "Bit 2 - This bit indicates that the ADC temperature sensor input buffer is powered down"]
    #[inline]
    pub fn vptatpwd(&mut self) -> _VPTATPWDW {
        _VPTATPWDW { w: self }
    }
    #[doc = "Bit 1 - This bit indicates that the ADC Band Gap is powered down"]
    #[inline]
    pub fn bgtpwd(&mut self) -> _BGTPWDW {
        _BGTPWDW { w: self }
    }
    #[doc = "Bit 0 - This bit indicates that the ADC is powered down"]
    #[inline]
    pub fn adcpwd(&mut self) -> _ADCPWDW {
        _ADCPWDW { w: self }
    }
}
