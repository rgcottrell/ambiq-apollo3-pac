...
impl W {
    ...
    #[doc = "Bit 6 - FIFO Half Full."]
    #[inline]
    pub fn fhf(&mut self) -> _FHFW {
        _FHFW { w: self }
    }
    #[doc = "Bit 5 - TX to RX finished."]
    #[inline]
    pub fn ft2rend(&mut self) -> _FT2RENDW {
        _FT2RENDW { w: self }
    }
    #[doc = "Bit 4 - Parity Error."]
    #[inline]
    ...
    #[doc = "Bit 2 - Framing error."]
    #[inline]
    pub fn fer(&mut self) -> _FERW {
        _FERW { w: self }
    }
    #[doc = "Bit 1 - FIFO empty (transmit) or full (receive)."]
    #[inline]
    pub fn tberbf(&mut self) -> _TBERBFW {
        _TBERBFW { w: self }
    }
    #[doc = "Bit 0 - RX FIFO not empty."]
    #[inline]
    pub fn fne(&mut self) -> _FNEW {
        _FNEW { w: self }
    }
}
