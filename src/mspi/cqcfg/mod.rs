...
pub struct CQAUTOCLEARMASKR {
    bits: bool,
}
impl CQAUTOCLEARMASKR {
...
#[doc = r" Proxy"]
pub struct _CQAUTOCLEARMASKW<'a> {
    w: &'a mut W,
}
impl<'a> _CQAUTOCLEARMASKW<'a> {
...
impl W {
    ...
    #[doc = "Bit 3 - Eanble clear of CQMASK after each pause operation. This may be useful when using software flags to pause CQ."]
    #[inline]
    pub fn cqautoclearmask(&mut self) -> _CQAUTOCLEARMASKW {
        _CQAUTOCLEARMASKW { w: self }
    }
    #[doc = "Bit 2 - Power off MSPI domain upon completion of DMA operation."]
    #[inline]
    pub fn cqpwroff(&mut self) -> _CQPWROFFW {
        _CQPWROFFW { w: self }
    }
    #[doc = "Bit 1 - Sets the Priority of the command queue dma request"]
    #[inline]
