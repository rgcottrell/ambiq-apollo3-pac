...
#[doc = "Possible values of the field `DPWROFF`"]
...
impl DPWROFFR {
    ...
    #[doc(hidden)]
    #[inline]
    pub fn _from(value: bool) -> DPWROFFR {
        match value {
            false => DPWROFFR::DIS,
            true => DPWROFFR::EN,
        }
...
#[doc = "Values that can be written to the field `DPWROFF`"]
pub enum DPWROFFW {
    #[doc = "Power off disabled value."]
    DIS,
    #[doc = "Power off enabled value."]
...
impl<'a> _DPWROFFW<'a> {
    ...
    #[inline]
    pub fn variant(self, variant: DPWROFFW) -> &'a mut W {
        {
    ...
    pub fn dis(self) -> &'a mut W {
        self.variant(DPWROFFW::DIS)
    }
    #[doc = "Power off enabled value."]
    #[inline]
    pub fn en(self) -> &'a mut W {
        self.variant(DPWROFFW::EN)
    }
