...
#[doc = r" Proxy"]
pub struct _TXCMPMMISW<'a> {
    w: &'a mut W,
}
impl<'a> _TXCMPMMISW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 3 - This bit holds the modem DSR interrupt status masked."]
    #[inline]
    pub fn dsrmmis(&mut self) -> _DSRMMISW {
        _DSRMMISW { w: self }
    }
    #[doc = "Bit 2 - This bit holds the modem DCD interrupt status masked."]
    #[inline]
    pub fn dcdmmis(&mut self) -> _DCDMMISW {
        _DCDMMISW { w: self }
    }
    #[doc = "Bit 1 - This bit holds the modem CTS interrupt status masked."]
    #[inline]
    ...
    #[doc = "Bit 0 - This bit holds the modem TXCMP interrupt status masked."]
    #[inline]
    pub fn txcmpmmis(&mut self) -> _TXCMPMMISW {
        _TXCMPMMISW { w: self }
    }
}
